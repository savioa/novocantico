...
<html lang="pt-br">
    ...
    <body>
                ...
                <div class="row show-grid">
                    <div class="col-md-8">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h1 class="panel-title"><xsl:value-of select='hino/numero'/> · <xsl:value-of select='hino/titulo'/></h1></div>
        ...
        <!-- Cloudflare Web Analytics --><script defer='defer' src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "454cfe05510349c19c4332c4c5bb8d63"}'></script><!-- End Cloudflare Web Analytics -->
    </body>
</html>
    </xsl:template>
</xsl:stylesheet>
