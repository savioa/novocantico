                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <dl>
                                    <dt>Assunto</dt>
                                    <dd><a href='../indice/assunto/index.html#{substring(/nc:hino/@sec, 1, 2)}'><xsl:value-of select='translate(substring(nc:hino/@sec, 4), "_", " ")'/></a> &#8250; <a href='../indice/assunto/index.html#{substring(/nc:hino/@ass, 1, 2)}{substring(/nc:hino/@ass, 4, 2)}'><xsl:value-of select='translate(substring(nc:hino/@ass, 7), "_", " ")'/></a></dd>

                                    <xsl:if test='nc:hino/nc:ori_let'>
                                    <dt>Origem da Letra</dt>
                                    <xsl:for-each select='nc:hino/nc:ori_let'>
                                    <dd><a href='../indice/origem-letra/index.html#{./@id}'><xsl:value-of select='./@id'/></a><xsl:if test='./@ano'> (<xsl:value-of select='./@ano'/>)</xsl:if></dd>
                                    </xsl:for-each>
                                    </xsl:if>
                                    ...
                                    <dd><a href='../indice/origem-musica/index.html#{./@id}'><xsl:value-of select='./@id'/></a><xsl:if test='./@ano'> (<xsl:value-of select='./@ano'/>)</xsl:if></dd>
                                    </xsl:for-each>
                                    </xsl:if>
                                    ...
                                    <dd><a href='../indice/referencia-biblica/index.html#{./@liv}_{./@cap}_{./@ver}'><xsl:value-of select='./@liv'/>#<xsl:value-of select='./@cap'/>.<xsl:value-of select='./@ver'/></a></dd>
                                    </xsl:for-each>
                                    </xsl:if>

                                    <dt>Título Original</dt>
                                    <xsl:choose>
                                    <xsl:when test='nc:hino/nc:tit_ori'>
                                    <xsl:for-each select='nc:hino/nc:tit_ori'>
                                    <dd><a href='../indice/titulo-original/index.html#{/nc:hino/@num}'><xsl:value-of select='.'/></a></dd>
                                    </xsl:for-each>
                                    </xsl:when>
                                    <xsl:otherwise>
                                    <dd><a href='../indice/titulo-original/index.html#{/nc:hino/@num}'><xsl:value-of select='nc:hino/@tit'/></a></dd>
                                    </xsl:otherwise>
                                    </xsl:choose>

                                    <dt>1º Verso Original</dt>
                                    <xsl:choose>
                                    <xsl:when test='nc:hino/nc:pri_ver_ori'>
                                    <xsl:for-each select='nc:hino/nc:pri_ver_ori'>
                                    <dd><a href='../indice/primeiro-verso-original/index.html#{/nc:hino/@num}'><xsl:value-of select='.'/></a></dd>
                                    </xsl:for-each>
                                    </xsl:when>
                                    <xsl:otherwise>
                                    <dd><a href='../indice/primeiro-verso-original/index.html#{/nc:hino/@num}'><xsl:value-of select='nc:hino/nc:tex/nc:est[1]/nc:ver[1]/.'/></a></dd>
                                    </xsl:otherwise>
                                    </xsl:choose>
                                    ...
                                    <dd><a href='../indice/metrica/index.html#{/nc:hino/@met}'><xsl:value-of select='.'/></a></dd>
                                    </xsl:for-each>
                                    </xsl:if>
                                </dl>
                            </div>
